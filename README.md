...
## Alena | Software Engineer → QA Engineer 🔍

QA Engineer transitioning from software development to QA Automation.  
My engineering background helps me:  
...
- Skilled in Java, Python, Web & API testing  
- Strong analytical mindset with a focus on root cause analysis  
- Continuously learning test automation tools and techniques  

---

## 🧪 QA Skills
- Test case design & management  
- Bug reporting (Jira, YouTrack, Test IT, Qase)  
...
<div style="display:flex; gap:10px; align-items:center;">
  ...
  <a href="https://www.linkedin.com/in/zkhhelen" target="_blank" style="text-decoration:none; display:flex; align-items:center;">
    <img src="https://upload.wikimedia.org/wikipedia/commons/c/ca/LinkedIn_logo_initials.png" width="20" style="margin-right:5px;" alt="LinkedIn">
    <span style="background-color:#000000; color:#ffffff; font-weight:bold; padding:5px 10px; border-radius:5px; font-family:sans-serif;">LinkedIn</span>
  </a>
